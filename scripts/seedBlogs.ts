...
const stmt = db.prepare(`
  INSERT OR REPLACE INTO blogs (title, slug, date, content, excerpt, emoji, seoTitle, seoDescription, seoKeywords)
  VALUES (@title, @slug, @date, @content, @excerpt, @emoji, @seoTitle, @seoDescription, @seoKeywords)
`);
